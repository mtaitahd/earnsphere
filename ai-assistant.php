        ...
        <div class="content-type-grid" id="contentTypeGrid">
            <?php foreach ($contentTypes as $type): 
                $icon = match($type) {
                    ...
                    'seo_title' => 'fa-solid fa-magnifying-glass',
                    'seo_description' => 'fa-solid fa-pen',
                    'landing_page_copy' => 'fa-solid fa-laptop',
                    'homepage_hero' => 'fa-solid fa-house',
                    'referral_landing_copy' => 'fa-solid fa-user-plus',
